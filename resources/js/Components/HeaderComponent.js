...
export class HeaderComponent extends Component {
    #header = `<div class="w-full header z-30 sticky top-0 dark:bg-gray-800 bg-indigo-600 flex flex-row items-center justify-between border-b-1 border-gray-400 py-4">
                    ...
                    <input hidden type="text" name="group_id" value="" />
                </div>`;
